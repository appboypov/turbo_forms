...
class TurboFormFieldState<T> extends Equatable {
  ...
  final T? value;
  final TurboValuesValidatorDef<T>? valuesValidator;
  final bool isEnabled;
  final bool isReadOnly;
  final bool isVisible;
  final bool obscureText;
  final TurboFieldType fieldType;
  final Object id;
  ...
  TurboFormFieldState<T> copyWith({
